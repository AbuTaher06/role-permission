                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('products.update', $product->id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="details" class="form-control @error('details') is-invalid @enderror" name="details" required autocomplete="details">{{ old('details', $product->details) }}</textarea>
